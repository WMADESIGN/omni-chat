...
import { locale as menuPortugueseBR } from 'app/menu/i18n/pt-BR';
...
export class AppComponent implements OnInit, OnDestroy {
  coreConfig: any;
  menu: any;
  defaultLanguage: 'pt-BR'; // This language will be used as a fallback when a translation isn't found in the current language
  appLanguage: 'pt-BR'; // Set application default language i.e fr
  ...
  constructor(
    ...
    this._coreTranslationService.translate(menuPortugueseBR);
